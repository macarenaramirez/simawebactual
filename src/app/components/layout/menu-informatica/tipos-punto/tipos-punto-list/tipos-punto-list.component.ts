...
@Component({
  selector: 'app-tipos-punto-list',
  templateUrl: './tipos-punto-list.component.html',
  styleUrls: ['./tipos-punto-list.component.css']
})
export class MenuListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.menuSeleccionado.nombre = 'Listado de Tipos de Punto';
  ...
  nuevo() {
    this.router.navigateByData({
      url: ['/menu-informatica/panel-de-control/tipos-punto/form-new'],
  ...
  edit(menuEdit: MenuFormModel) {
    this.router.navigateByData({
      url: ['/menu-informatica/panel-de-control/tipos-punto/form-edit'],
