...
@Component({
  selector: 'app-tipos-punto-form-edit',
  templateUrl: './tipos-punto-form-edit.component.html',
  styleUrls: ['./tipos-punto-form-edit.component.css']
})
export class MenuFormEditComponent implements OnInit {
  ...
  back() {
    this.router.navigateByData({
      url: ['menu-informatica/panel-de-control/tipos-punto/list'],
      data: [this.menuPadre]
    });
  }
