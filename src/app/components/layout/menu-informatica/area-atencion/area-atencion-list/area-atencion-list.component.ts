...
@Component({
  selector: 'app-area-atencion-list',
  templateUrl: './area-atencion-list.component.html',
  styleUrls: ['./area-atencion-list.component.css']
})
export class MenuListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.menuSeleccionado.nombre = 'Listado de Áreas de Atención';
  ...
  nuevo() {
    this.router.navigateByData({
      url: ['/menu-informatica/panel-de-control/area-atencion/form-new'],
  ...
  edit(menuEdit: MenuFormModel) {
    this.router.navigateByData({
      url: ['/menu-informatica/panel-de-control/area-atencion/form-edit'],
