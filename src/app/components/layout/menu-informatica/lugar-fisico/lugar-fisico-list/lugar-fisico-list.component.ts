...
@Component({
  selector: 'app-lugar-fisico-list',
  templateUrl: './lugar-fisico-list.component.html',
  styleUrls: ['./lugar-fisico-list.component.css']
})
export class MenuListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.menuSeleccionado.nombre = 'Listado de Lugares Fisicos';
  ...
  nuevo() {
    this.router.navigateByData({
      url: ['/menu-informatica/panel-de-control/lugar-fisico/form-new'],
  ...
  edit(menuEdit: MenuFormModel) {
    this.router.navigateByData({
      url: ['/menu-informatica/panel-de-control/lugar-fisico/form-edit'],
