...
@Component({
  selector: 'app-lugar-fisico-form-new',
  templateUrl: './lugar-fisico-form-new.component.html',
  styleUrls: ['./lugar-fisico-form-new.component.css']
})
export class MenuFormNewComponent implements OnInit {
  ...
  back() {
    this.router.navigateByData({
      url: ['menu-informatica/panel-de-control/lugar-fisico/list'],
      data: [this.menuPadre]
    });
  }
