...
@Component({
  selector: 'app-punto-atencion-form-new',
  templateUrl: './punto-atencion-form-new.component.html',
  styleUrls: ['./punto-atencion-form-new.component.css']
})
export class MenuFormNewComponent implements OnInit {
  ...
  back() {
    this.router.navigateByData({
      url: ['menu-informatica/panel-de-control/area-atencion/list'],
      data: [this.menuPadre]
    });
  }
