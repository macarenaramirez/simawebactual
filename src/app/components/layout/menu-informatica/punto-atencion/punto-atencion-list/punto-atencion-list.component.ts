...
@Component({
  selector: 'app-punto-atencion-list',
  templateUrl: './punto-atencion-list.component.html',
  styleUrls: ['./punto-atencion-list.component.css']
})
export class MenuListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.menuSeleccionado.nombre = 'Listado de Puntos de Atención';
  ...
  nuevo() {
    this.router.navigateByData({
      url: ['/menu-informatica/panel-de-control/punto-atencion/form-new'],
  ...
  edit(menuEdit: MenuFormModel) {
    this.router.navigateByData({
      url: ['/menu-informatica/panel-de-control/punto-atencion/form-edit'],
