...
@Component({
  selector: 'app-punto-atencion-form-edit',
  templateUrl: './punto-atencion-form-edit.component.html',
  styleUrls: ['./punto-atencion-form-edit.component.css']
})
export class MenuFormEditComponent implements OnInit {
  ...
  back() {
    this.router.navigateByData({
      url: ['menu-informatica/panel-de-control/punto-atencion/list'],
      data: [this.menuPadre]
    });
  }
