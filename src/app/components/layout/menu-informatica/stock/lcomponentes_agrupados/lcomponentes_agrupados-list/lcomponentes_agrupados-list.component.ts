...
@Component({
  selector: 'app-lcomponentes_agrupados-list',
  templateUrl: './lcomponentes_agrupados-list.component.html',
  styleUrls: ['./lcomponentes_agrupados-list.component.css']
})
export class MenuListComponent implements OnInit {
  ...
  nuevo() {
    this.router.navigateByData({
      url: ['/menu-informatica/panel-de-control/lcomponentes_agrupados/form-new'],
  ...
  edit(menuEdit: MenuFormModel) {
    this.router.navigateByData({
      url: ['/menu-informatica/panel-de-control/lcomponentes_agrupados/form-edit'],
