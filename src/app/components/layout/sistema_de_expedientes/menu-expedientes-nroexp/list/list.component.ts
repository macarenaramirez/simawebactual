...
export class ListComponent implements OnInit {
  ...
  getExpedientes() {
    this.expedientesResourceService.getExpedientes(this.storageService.sessionId,this.nroDocide, this.indTipdocide).subscribe(
      responseBaseExpedientesModel => {
        ...
        if (responseBaseExpedientesModel.status) {
          ...
          swal.fire('Ocurrió un problema al listar la expedientes', responseBaseExpedientesModel.message, 'warning');
        }
      },
      (errors) => {
